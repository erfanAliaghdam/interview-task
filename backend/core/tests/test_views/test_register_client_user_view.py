...
class RegisterClientUserViewTest(BaseAPITestClass):
    ...
    @patch(
        "core.api.v1.views.register_client_user_view."
        "RegisterUserService.register_client_user"
    )
    @patch("core.api.v1.views.register_client_user_view." "Token.objects.get_or_create")
    ...
    @patch("core.api.v1.views.register_client_user_view." "logging.error")
    @patch(
        "core.api.v1.views.register_client_user_view."
        "RegisterUserService.register_client_user"
    )
